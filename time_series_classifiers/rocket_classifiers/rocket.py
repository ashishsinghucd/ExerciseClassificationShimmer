...
class RocketTransformerClassifier:
    ...
    def fit_rocket(self, x_train, y_train, train_pid, kernels=10000):
        ...
        rocket = Rocket(num_kernels=kernels, normalise=True)  # random_state=100343
        rocket.fit(x_train)
        ...
        # logger.info("Train and demo features combined data shape: {} {}".format(x_training_transform_combined.shape,
        #                                                                         y_train.shape))
    ...
    def calc_error_rate(self, data_pid, y_test, predictions):
        """
        ...
        pid_info_df.to_csv("/tmp/pid_tempinfo.csv", index=False)
